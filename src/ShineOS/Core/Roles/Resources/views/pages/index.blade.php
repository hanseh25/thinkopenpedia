            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="feature_list">
                  <div class="box no-border">
                      ...
                      <div class="box-body table-responsive no-padding overflowx-hidden">
                        <div class="input-group-btn mb10">
                          <a href="{{ url('roles/add/feature')}}" class="btn btn-primary pull-right">Add New Feature</a>
                        </div>
                        ...
                        <table class="table table-hover">
                          ...
                          @foreach ($featureItems as $key=>$val)
                            <tr>
                              ...
                              <td class="text-center">
                                <div class="btn-group">
                                    @if ( Modules\Roles\Entities\Features::checkIfCore($val['feature_name']) == true )
                                      <!--<a href="{{ route('roles.edit.feature', [$val['feature_id']]) }}" type="button" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i> Edit </a>-->
                                      <a href="{{ url('/roles/delete', [$val['feature_id']]) }}" type="button" class="btn btn-default btn-flat"><i class="fa fa-trash-o"></i> Delete </a>
                                    @else
