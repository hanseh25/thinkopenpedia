    ...
    {!! Form::open(array( 'method' => 'post', 'class' => 'form-horizontal', 'route' => 'pedia.growth.add') ) !!}
    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-8 input-group">
                                    <input type="number" name="age" class="form-control" required="required" step="any" min="0" >
