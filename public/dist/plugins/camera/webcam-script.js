$(document).ready(function(){
	...
	webcam.set_swf_url('/shineos/content/includes/js/webcam.swf');
	webcam.set_api_url('/shineos/commons/uploads');	// The upload script
	webcam.set_quality(100);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, '/shineos/content/includes/js/shutter.mp3');
	...
	function loadPics(){
		...
		$.getJSON('/shineos/content/includes/browse.php',{'start':start},function(r){
